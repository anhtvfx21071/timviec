            ...
            <div class="col-lg-12 pr-lg-5">
                <div class="row">
                    <c:forEach var="savejob" items="${listSaveJob}">
                            ...
                            <div class="job-post-item p-4 d-block d-lg-flex align-items-center">
                                <div class="one-third mb-4 mb-md-0">
                                    <div class="job-post-item-header align-items-center">
                                        <span class="subadge">${savejob.recruitmentSave.type}</span>
                                        <h2 class="mr-3 text-black">${savejob.recruitmentSave.title}</h2>
                                    </div>
                                    <div class="job-post-item-body d-block d-md-flex">
                                        <div class="mr-3"><span
                                                class="icon-layers"></span>${savejob.recruitmentSave.companyRe.nameCompany}
                                        </div>
                                        <div><span class="icon-my_location"></span>
                                            <span>${savejob.recruitmentSave.address}</span></div>
                                    </div>
                                </div>
                                <div class="one-forth ml-auto d-flex align-items-center mt-4 md-md-0">
                                    <div>
                                        <a onclick="save(${savejob.recruitmentSave.id})"
                                           class="icon text-center d-flex justify-content-center align-items-center icon mr-2">
                                            <span class="icon-heart"></span>
                                        </a>
                                    </div>
                                    <a data-toggle="modal"
                                       data-target="#exampleModal${savejob.recruitmentSave.id}"
                        ...
                        <!-- end -->
                        <!-- Modal -->
                        <div class="modal fade" id="exampleModal${savejob.recruitmentSave.id}" tabindex="-1"
                             role="dialog"
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Ứng tuyển:
                                            <span>${savejob.recruitmentSave.title}</span></h5>
                                    ...
                                    <form action="${pageContext.request.contextPath}/user/apply" method="post"
                                        ...
                                        <div class="col-12">
                                            <select class="form-control" aria-label="Default select example"
                                                    id="submissionMethod${savejob.recruitmentSave.id}"
                                                    onchange="toggleFields(${savejob.recruitmentSave.id})">
                                                <option selected>Chọn phương thức nộp</option>
                                                <option value="1">Dùng cv đã cập nhật</option>
                                                <option value="2">Nộp cv mới</option>
                                            </select>
                                        </div>
                                        <div id="introductionDiv${savejob.recruitmentSave.id}" style="display:none"
                                             class="col-12">
                                            <input type="hidden" name="idRecruitment"
                                                   value="${savejob.recruitmentSave.id}">
                                            <input type="hidden" name="status" value="1">
                                            <label class="col-form-label">Giới thiệu:</label>
                                            <textarea name="text" rows="10" cols="3" class="form-control"></textarea>
                                        </div>
                                        <div id="cvDiv${savejob.recruitmentSave.id}" style="display:none"
                                             class="col-12">
                                            <input type="hidden" name="idRecruitment"
                                                   value="${savejob.recruitmentSave.id}">
                                            <input type="hidden" name="status" value="1">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button style="display:none" type="submit" class="btn btn-primary"
                                                    id="nopCv${savejob.recruitmentSave.id}">Nộp
                                            </button>
                                        </div>
                                    </form>
                                </div>
