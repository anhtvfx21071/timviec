                    ...
                    <div>
                        ...
                        <div>
                            <span class="icon-briefcase mr-2"></span><a
                                class="ml-0 mr-2 mb-2">${recruitment.companyRe.nameCompany}</a>
            ...
            <div class="col-lg-4">
                <div class="bg-light p-3 border rounded mb-4">
                    ...
                    <ul class="list-unstyled pl-3 mb-0">
                        <li class="mb-2"><strong class="text-black">Ngày tạo: </strong> <span></span></li>
                        ...
                        <li class="mb-2"><strong class="text-black">Loại công việc: </strong>
                            <span>${recruitment.categoryRe.name}</span></li>
...
<section class="ftco-section bg-light">
    <div class="contai">
        <h3><strong>Danh sách ứng tuyển: </strong><span style="color: #ffc107">${recruitment.title}</span></h3>
        <div class="content">
